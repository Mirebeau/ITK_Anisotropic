 ...
 *
 *=========================================================================*/
#ifndef __itkFastMarchingImageFilter_Modified_h
#define __itkFastMarchingImageFilter_Modified_h
...
namespace itk
{
/** \class FastMarchingImageFilter_Modified
...
class ITK_EXPORT FastMarchingImageFilter_Modified:
  public ImageToImageFilter< TSpeedImage, TLevelSet >
{
public:
  /** Standard class typdedefs. */
  typedef FastMarchingImageFilter_Modified    Self;
  ...
  itkTypeMacro(FastMarchingImageFilter_Modified, ImageSource);
...
private:
  ...
  itkConceptMacro( SameDimensionCheck,
    ...
    // Modified by Mirebeau January 7th 2013,
    // to allow for anisotropic speeds (direction dependent).
...
private:
  FastMarchingImageFilter_Modified(const Self &); //purposely not implemented
...
protected:
    // Modified by Mirebeau January 7th 2013
    // Access required for subclassing, and redefining member function
...
#include "itkFastMarchingImageFilter_Modified.hxx"
#endif
